...
import { o as defu, C as hasProtocol, S as withLeadingSlash, G as joinURL, M as parseURL, r as encodeParam, s as encodePath } from '../nitro/nitro.mjs';
import { an as useHead, as as useNuxtApp, ay as useRuntimeConfig } from './server.mjs';
...
const ipxRuntime$ytghOFNIVPNTckfDAxeSQNItaIYEPYq6WlPRnS2dt84 = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$ytghOFNIVPNTckfDAxeSQNItaIYEPYq6WlPRnS2dt84, defaults: {} }
  }
};
...
const __nuxt_component_5 = Object.assign(_sfc_main, { __name: "NuxtImg" });

export { __nuxt_component_5 as _ };
//# sourceMappingURL=NuxtImg-zNev45Bl.mjs.map
